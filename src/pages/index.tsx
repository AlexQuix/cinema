...
import Popular from "@container/content-popular";
import LoaderMediaCarousel from "@container/LoaderMediaCarousel";
...
function Home(){
    return (<>
        <div>
            ...
            <LoaderMediaCarousel getUrl={(media) =>`/api/${media}/trending`}
                                initialMedia="movie">
                <LoaderMediaCarousel.Header>
            ...
            <Trailers url={(mediatype)=>`/api/${mediatype}/trending`}
                    styletype={2}/>

            <LoaderMediaCarousel initialMedia="movie"
                            getUrl={(media)=>`/api/${media}/upcoming`}>
                <LoaderMediaCarousel.Header enableSelectedMedia={false}>
            ...
            <LoaderMediaCarousel initialMedia="tv"
                            getUrl={(media)=>`/api/${media}/on_the_air`}>
                <LoaderMediaCarousel.Header enableSelectedMedia={false}>
