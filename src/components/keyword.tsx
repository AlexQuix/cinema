...
function Keyword({result, setIskeywords}:{result:Search.Keywords, setIskeywords:React.Dispatch<React.SetStateAction<boolean>>}){
    function getYear(date:string){
        if(date){
            let year = date.match(/[0-9]*/);
            return (
                <b style={{fontWeight:400}}> - {year}</b>
            );
        }
        return undefined
    }
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <span>{data.name}{getYear(data.first_air_date)}</span>
                </a>
            </LINK>
        )
    }
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <span>{data.title}{getYear(data.release_date)}</span>
                </a>
            </LINK>
        )
    }
